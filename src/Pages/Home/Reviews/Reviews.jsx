    ...
    <div>
      ...
      >
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <h2 className="text-center text-xl md:text-4xl font-bold tracking-tight sm:text-5xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
            <blockquote className="rounded-lg bg-gray-100 p-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-base md:text-lg font-medium text-gray-700">
                    Mashud Al Hasan
                  </p>
                </div>
              </div>
              ...
              <p className="text-sm md:text-base mt-4 text-gray-500">
                ...
                of zooming it around. Highly recommended!&quot;
              </p>
            </blockquote>
            ...
            <blockquote className="rounded-lg bg-gray-100 p-8">
              ...
              <p className="text-sm md:text-base mt-4 text-gray-500">
                ...
                fantastic, the prices are reasonable, and the customer service
                is top-notch. A definite winner!&quot;
              </p>
            </blockquote>
            ...
            <blockquote className="rounded-lg bg-gray-100 p-8">
              ...
              <p className="text-sm md:text-base mt-4 text-gray-500">
                ...
                son&apos;s face lit up when he saw it. Toy Land is where
                I&apos;ll be shopping for all future toy purchases.&quot;
              </p>
            </blockquote>
          </div>
        </div>

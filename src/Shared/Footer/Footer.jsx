            ...
            <div className="w-4/5 px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-body-color mb-7 text-base">
                  Experience boundless joy at Toy Land! Shop now and unleash the
                  magic of childhood!
                </p>
              ...
              <div className="mb-10 w-full">
                ...
                <ul>
                  <li>
                    <Link
                      to="/blog"
                      className="text-body-color hover:text-info mb-2 inline-block text-base leading-loose"
                    >
                      Toy Land Blog
                    </Link>
                  </li>
              ...
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <Link
                    ...
                    className="text-dark hover:bg-info hover:border-info mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
          ...
          <span className="absolute left-0 bottom-0 z-[-1]">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#00BFFF" stopOpacity="0.08" />
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stopColor="#00BFFF" stopOpacity="0.31" />
                  <stop offset="1" stopColor="#C4C4C4" stopOpacity="0" />
                </linearGradient>
              </defs>
            </svg>
